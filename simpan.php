...
$nama_file_unik=$acak.$nama_file;
    ...
    $email=$_POST['email'];
        ...
        $simpan=mysqli_query($koneksi,"INSERT INTO pelapor VALUES ('$noktp','$nama','$tempatlhr','$tgllahr','$jenkel','$alamat','$lurah_desa','$nohp','$email','$nama_file_unik')") or die(mysqli_error());
        // untuk tabel laporan 
        ...
        $simpantabelpelapor=mysqli_query($koneksi, "INSERT INTO laporan VALUES(NULL,'$tanggal','$noktp','$isi_laporan','$kasus','$lokasi_kejadian','$tgl_kejadian','$ciri_ciri_pelaku','$kronologis','0')");
...
<div class="col-md-2 col-sm-2"></div>
                    ...
                    <div class="panel panel-primary" id="print">
                        ...
                        <div class="panel-body">
                             <center> <img src="assets/img/logo_BNN.png" /></center><br>   
                             <center><h1>LAPORAN BADAN NARKOTIKA NASIONAL</h1></center><br>
